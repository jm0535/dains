...
if(requireNamespace("zoo", quietly = TRUE)) {
  library(zoo)
  wheat_ts <- zoo(time_series_data$`Wheat (tonnes per hectare)`, time_series_data$Year)
  ...
  # Add trend line
  lines(lowess(time_series_data$Year, time_series_data$`Wheat (tonnes per hectare)`), col = "red", lwd = 2)
} else {
  # Basic plot if zoo package is not available
  plot(time_series_data$Year, time_series_data$`Wheat (tonnes per hectare)`, type = "l",
