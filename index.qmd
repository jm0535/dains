...
# Data Analysis in Natural Sciences {.hero-title}

### An R-Based Approach {.hero-subtitle}
...
**Dr. Jimmy Moses** is a Papua New Guinean entomologist and lecturer at the Papua New Guinea University of Technology's School of Forestry. He specializes in ant ecology, biostatistics, and geospatial analysis, with a Ph.D. in Entomology from the University of South Bohemia (2021).
...
*No prior programming experience is required* — we start from the basics and build up progressively.
...
- The **tidyverse** and **tidymodels** teams for transforming how we work with data
